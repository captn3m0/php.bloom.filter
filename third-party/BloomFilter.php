 ...
 *
 * LICENSE: Provided as is without any guarantees, do with it whatever you like.
 */

namespace Razorpay\BloomFilter\Others;
...
class BloomFilter
{
    ...
    public function showBitField()
    {
        return join(
            array_map(
                function ($chr) {
                    return str_pad(base_convert(bin2hex($chr), 16, 2), 8, '0', STR_PAD_LEFT);
                },
                str_split($this->bitField)
            )
        );
    }
